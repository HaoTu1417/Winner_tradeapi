...
// Type: tradeapi.Models.Finance.BorrowPlanResponse
...
#nullable enable
namespace tradeapi.Models.Finance
{
    public class BorrowPlanResponse
    {
        ...
        public List<string> fastbtns { get; set; } = new List<string>();
